...
The 2026-04-20 spec-delta cleanup batch (`c9bc877..803328c`) resolved 25 of 27 deferred items logged across M1–M9. See the spec-delta log for per-item details of what changed (entries #58–#70 + #73–#79 + #81–#84). The three items below are intentionally deferred to future sessions — each is substantial design or research work, not a narrow fix. SD #71 (Kuzu embedding mutability) is resolved — Kuzu has been fully excised in M11 and replaced by Neo4j Community.
...
43. **M11 — Neo4j backend stand-up + Kuzu excision (`2b3bc08..4d69272`, 9 tasks).** Neo4j Community 5.x replaces KùzuDB as the second storage backend alongside Memgraph. Concrete changes:
    ...
    - **M11.10** — Docs propagation (this entry). Closing commit TBD.
